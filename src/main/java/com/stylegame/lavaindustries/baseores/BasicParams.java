...
public class BasicParams extends Block {

    public BasicParams(Material MaterialBlock, String NameRegistry, String NameLocalized, String ToolClass, int ToolLevel, float Resistance, float Hardness) {
